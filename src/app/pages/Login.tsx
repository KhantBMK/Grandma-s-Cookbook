      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="max-w-md mx-auto">
          <div className="border-2 border-orange-900/20 rounded-3xl p-8 bg-white">
            <h1 className="text-3xl text-orange-900 mb-8 text-center">Welcome Back</h1>
            
            <form onSubmit={handleLogin} className="space-y-6">
              <div>
                <label htmlFor="username" className="block text-orange-900/60 mb-2 text-sm">
                  Username
                </label>
              ...
              <div>
                <label htmlFor="password" className="block text-orange-900/60 mb-2 text-sm">
                  Password
                </label>
                <div className="relative">
            ...
            <p className="mt-6 text-center text-orange-900/60 text-sm">
